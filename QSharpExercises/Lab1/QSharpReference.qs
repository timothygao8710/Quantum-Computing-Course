...
namespace QSharpExercises.QSharpReference {
    ...
    operation CommonTypes (inputQubit : Qubit, register : Qubit[]) : Unit {
        ...
        for i in range{
            Message("Whats good bros");
        }

        //Also you can for each loops
        // for i in Array{
        //     Message("I am in an array");
        // }

        // Arrays --> like lists in python, not arrays in c++
        ...
        set intArray w/= 3 <- 22;
        //Time complexity O(N), it's pretty slow --> generally people use other languages for classical computing parts
        ...
        //The inputs fills out the blanks respectively
    }


    /// Deallocation occurs after exiting function
