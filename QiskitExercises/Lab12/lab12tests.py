    ...
    def test_exercise_3(self):
        for i in range(0, 10):
            for number_of_qubits in range(3, 9):
                ...
                if lab12.exercise_3(number_of_qubits, lab12.always_zero) != True:
                    self.fail("Incorrectly classified always_zero as balanced.")

                if lab12.exercise_3(number_of_qubits, lab12.always_one) != True:
                    self.fail("Incorrectly classified always_one as balanced.")

                if lab12.exercise_3(number_of_qubits, lab12.exercise_1) != False:
                    self.fail("Incorrectly classified exercise_1 as constant.")

                if lab12.exercise_3(number_of_qubits, exercise_3_wrapper) != False:
